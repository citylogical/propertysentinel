...
export default function PropertySidebar({ initialTab = 'search' }: Props) {
  ...
  if (!isOpen) {
    return (
      <button
        type="button"
        className="prop-sidebar prop-sidebar-collapsed"
        aria-label="Expand sidebar"
        onClick={() => setIsOpen(true)}
      >
        <span className="prop-sidebar-collapsed-label">Menu</span>
      </button>
    )
  }

  return (
    <div className="prop-sidebar prop-sidebar-expanded">
