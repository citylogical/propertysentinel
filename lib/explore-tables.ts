...
const enriched_complaints: TableDef = {
  name: 'enriched_complaints',
  label: 'Enriched Complaints',
  rowEstimate: '1.9K+',
  defaultSort: 'created_date',
  defaultSortDesc: true,
  columns: [
    { key: 'sr_number', label: 'SR Number', type: 'text', defaultVisible: true, sticky: true },
    { key: 'created_date', label: 'Filed', type: 'date', defaultVisible: true },
    { key: 'sr_short_code', label: 'SR Code', type: 'text', defaultVisible: true },
    { key: 'sr_type', label: 'SR Type', type: 'text', defaultVisible: true },
    ...
    { key: 'trade_category', label: 'Trade', type: 'text', defaultVisible: true },
    { key: 'urgency_tier', label: 'Urgency', type: 'text', defaultVisible: true },
    { key: 'complainant_type', label: 'Complainant', type: 'text', defaultVisible: true },
    { key: 'unit_number', label: 'Unit', type: 'text', defaultVisible: true },
    { key: 'danger_reported', label: 'Danger', type: 'text' },
    { key: 'owner_notified', label: 'Owner Notified', type: 'text' },
    { key: 'owner_occupied', label: 'Owner Occupied', type: 'text' },
    { key: 'concern_category', label: 'Concern', type: 'text' },
    { key: 'restaurant_name', label: 'Restaurant', type: 'text' },
    { key: 'business_name', label: 'Business', type: 'text' },
    { key: 'problem_category', label: 'Problem', type: 'text' },
    { key: 'sla_target_days', label: 'SLA Target', type: 'number' },
    { key: 'actual_mean_days', label: 'Avg Days', type: 'number' },
    { key: 'workflow_step', label: 'Step', type: 'text' },
    { key: 'work_order_status', label: 'WO Status', type: 'text' },
    { key: 'closed_date', label: 'Closed', type: 'date' },
    { key: 'pin', label: 'PIN', type: 'text' },
    { key: 'community_area', label: 'Community Area', type: 'text' },
    { key: 'ward', label: 'Ward', type: 'text' },
    { key: 'enriched_at', label: 'Enriched', type: 'date' },
    { key: 'paraphrased_at', label: 'Paraphrased', type: 'date' },
    { key: 'salesforce_case_id', label: 'Salesforce ID', type: 'text' },
  ],
}
...
export const EXPLORE_TABLES: Record<string, TableDef> = {
  ...
  enriched_complaints: enriched_complaints,
