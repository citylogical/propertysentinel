...
export const SR_CODES: SRCodeEntry[] = [
  ...
  { code: 'WCA3',    label: 'Water Lead Test Visit Request',               category: 'building',           defaultVisible: true,  enrichable: true },
  ...
  { code: 'RFC',     label: 'Renters and Foreclosure Complaint',           category: 'business',           defaultVisible: true,  enrichable: true },
  ...
  { code: 'SCT',     label: 'Clean Vacant Lot Request',                    category: 'other',              defaultVisible: true,  enrichable: true },
  { code: 'SCX',     label: 'Recycling Inspection Request',                category: 'other',              defaultVisible: true,  enrichable: true },
  ...
  { code: 'SCP',     label: 'Weed Removal Request',                        category: 'street_nuisance',    defaultVisible: true,  enrichable: true },
  ...
  { code: 'SDR',     label: 'Fly Dumping Complaint',                       category: 'street_nuisance',    defaultVisible: true,  enrichable: true },
  ...
  { code: 'PBE',     label: 'Pavement Cave-In Inspection Request',         category: 'street_infrastructure', defaultVisible: true },
  ...
  { code: 'SCSP',    label: 'Shared Cost Sidewalk Program Request',        category: 'street_infrastructure', defaultVisible: true,  enrichable: true },
  ...
  { code: 'SWSNOREM',label: 'Snow – Uncleared Sidewalk Complaint',         category: 'street_infrastructure', defaultVisible: true,  enrichable: true },
