...
export const SR_CODES: SRCodeEntry[] = [
  ...
  { code: 'SCP',     label: 'Weed Removal Request',                        category: 'street_nuisance',    defaultVisible: true },
  ...
  { code: 'SDR',     label: 'Fly Dumping Complaint',                       category: 'street_nuisance',    defaultVisible: true },
  ...
  { code: 'SWSNOREM',label: 'Snow – Uncleared Sidewalk Complaint',         category: 'street_infrastructure', defaultVisible: true },
